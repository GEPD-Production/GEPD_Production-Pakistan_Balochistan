...
do "C:\Users\wb589124\WBG\HEDGE Files - HEDGE Documents\GEPD-Confidential\General\Country_Data\GEPD_Production-Pakistan_Balochistan\profile_GEPD.do"
...
recode m1saq7 (0/50=1 "50 or less") (51/200=2 "51-200 inclu") ///
(201/400=3 "201-400 inclu") ///
(401/600=4 "401-600 inclu") (601/800=5 "601-800 inclu") ///
(801/1000=6 "801-1000 inclu") ///
(1001/max=7 "More than 1000")(.=.), gen (total_enrolled_c)
...
recode m1saq8a_etri (0/3=1 "3 and less") ///
(4/10=2 "4-10 inclu") (11/30=3 "11-30 inclu") ///
(31/50=4 "31-50 inclu") (51/70=5 "51-70 inclu") ///
(71/90=6 "71-90 inclu") (91/max=7 "More than 90")(.=.), gen (m1saq8a_etri_c)
...
recode m7saq8_y (26/max=31 "more than 25 years")(.=.), gen (m7saq8_c)
...
recode m7saq9 (0/35=35 " 35 years old and less")(59/max=59 "more than 58 years")(.=.), gen (m7saq9_c)
	tab m7saq9_c, m
...
recode m7shq2_satt (0/25000=25000 "25000 and less") (180000.01/max=180001 "more than 180000")(.=.), gen (m7shq2_satt_c)
	tab m7shq2_satt_c, m
...
*--- Age (Two steps control)-- this shall be investigated on a case by case basis (depending on each dataset)
tab m3saq6, m			
replace m3saq6=36 if m3saq6==360		//fixing some errors 
...
recode m3saq6 (0/27=27 " 27 years old and less")(60/max=60 "more than 59 years")(.=.), gen (m3saq6_c)
	tab m3saq6_c, m
...
flag_unmatched tag_v2 flag_mismatch school_collapse_temp similscore max_matchscore flag_merge2 pedagogy_match m3sb_troster2 m3sb_troster3 questionnaire_match assessment_match m2saq23 m2saq24 m2saq25
...
capture noisely isid school_code ecd_assessment__id 
...
log on dropped_vars								
*Dropping un necessary varibales 
loc drop school_code school_name_preload _merge m8s1q1 interview__id interview__key school interview__id interview__key school district tehsil shift schoollevel strata location enatorialdistrict classification ///
